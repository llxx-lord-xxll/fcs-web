...
@section('title')
    APPLY AS A LOCAL HEROES
@endsection

@section('page-content')
    <section id="chapter-recruitment" class="form-background">
        <div class="container-fluid">
            <div class="row">
                <div class="fcs-form-container">
                    <form action="chapter-recruitment.html" method="post">
                        <ul class="fcs-form-outer">
                            ...
                            <li>
                                ...
                                <input type="tel" id="phone_number" name="phone_number" placeholder="e.g. +852 - 6582 8563"
                                       required>
                            </li>
                            <li>
                            ...
                            <li>
                                <label for="chapters_personnel_resume"> Resume </label>
                                <input type="file" id="chapters_personnel_resume" name="chapters_personnel_resume"
                                       accept=".doc,.docx,.ppt, .pptx,.pdf">
                            </li>
                            <li>
                                <label for="chapter-pitching-deck">Share with us if you have any projects / startups/
                                    ventures you are carrying on for now relevant to City Innovation </label>
