    ...
    <section id="fcs-story-info">
        <article class="fcs-story-article">
            ...
            <div class="fcs-article-content">
                ...
                <p>Ryan learnt about Future City Summit from our alumni Russ Earl Malagen(FCS2016), awardee of Connected World Magazine P10NEERS 2018. They first met in Startup Weekend Manila working together on the robotics hack for cleaning up water waste in Manila with IoT capability, increasing values of property and opportunities for housing and business centre. With the encouragement of Russ, Ryan joined the FCS in Hong Kong.</p>
                <div class="row">
                ...
                <div class="row fcs-human-grid1">
                    ...
                    <div class="row fcs-human-grid1">
                        <p>Meanwhile, winning the Best Presenter in Metro-Hackathon in FCS, Ryan was invited to the UN High Level Roundtable Meeting concerning Blended Capital and how stakeholders shall have roles in social entrepreneurship movement.</p>
